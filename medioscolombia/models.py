...
class Sociedad(models.Model):
	...
	paissocio = select2.fields.ForeignKey(PaisSociedad, verbose_name="País de origen", null=True, blank=True)
	...
	representantelegal = select2.fields.ForeignKey(Ejecutivo, verbose_name="Representante Legal", max_length=255, null=True, blank=True)
	...
	sectores = select2.fields.ManyToManyField(Sector, verbose_name="Sectores de Actividad", blank=True, help_text="Actualice con F5")
...
class Propietario(models.Model):
	...
	presidentedirectorio = select2.fields.ForeignKey(Empresario, related_name="propietario_presidentedirectorio", verbose_name="Presidente Directorio", null=True, blank=True)
	miembrosdirectorio = select2.fields.ManyToManyField(Empresario, related_name="propietario_miembrosdirectorio", verbose_name="Miembros Directorio", blank=True, help_text="Actualice con F5")
	representantelegal = select2.fields.ForeignKey(Ejecutivo, verbose_name="Representante Legal", max_length=255, null=True, blank=True)
	utilidades = models.CharField("Utilidades -último año-", max_length=255, null=True, blank=True)
	infoutilidades = models.CharField("Información Utilidades", max_length=255, null=True, blank=True)
	...
	pcentsociedadn = models.CharField("Porcentaje", max_length=255, null=True, blank=True)
	fechainfo = models.DateField("Fecha Información", null=True, blank=True)
	fuentesociedad = select2.fields.ForeignKey(Fuente, verbose_name="Fuente", related_name="fuente2sociedad", null=True, blank=True, max_length=255)
	...
	grupo = select2.fields.ForeignKey('Grupo', null=True, blank=True)
	...
	actualizado = models.DateTimeField(auto_now=True)
	app = models.CharField("País", default="Colombia", max_length=10, editable=False)
...
class Grupo(models.Model):
	...
	def __unicode__(self):
		return self.grupo
	controladorgrupo = select2.fields.ForeignKey(Sociedad, verbose_name="Controlador Grupo", max_length=255, null=True, blank=True)
	...
	otrosnegociosgrupo = select2.fields.ManyToManyField(Sector, verbose_name="Otros Negocios Controlador", blank=True)
	paisorigen = select2.fields.ForeignKey(PaisSociedad, related_name="pais_grupo", verbose_name="País de Origen", blank=True)
...
class Escrito(models.Model):
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Departamento", blank=True, help_text="Actualice con F5")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Municipio", blank=True, help_text="Actualice con F5")
...
class Radio(models.Model):
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Departamento", related_name="radio_region", blank=True, help_text="Actualice con F5")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Municipio", related_name="radio_ciudad", blank=True, help_text="Actualice con F5")
	direccion = models.CharField("Dirección", max_length=255, blank=True, help_text="Calle-Nº-Departamento-Municipio")
	sitioweb = models.URLField("Sitio WEB", max_length=255, null=True, blank=True, help_text="http://...")
...
class CanalTV(models.Model):
	...
	genero = select2.fields.ForeignKey(GeneroCanalTV, related_name="canaltv_genero", null=True, blank=True)
	inicio = models.DateField("Fecha Fundación", null=True, blank=True)
	inicioyear = models.IntegerField(('Año'), choices=YEAR_CHOICES, default=datetime.datetime.now().year, null=True, blank=True)
	COBERTURA = (
		('Nacional', 'Nacional'),
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Departamento", related_name="canaltv_region", blank=True, help_text="Actualice con F5")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Municipio", related_name="canaltv_ciudad", blank=True, help_text="Actualice con F5")
	direccion = models.CharField("Dirección", max_length=255, blank=True, help_text="Calle-Nº-Departamento-Municipio")
	sitioweb = models.URLField("Sitio WEB", max_length=255, null=True, blank=True, help_text="http://...")
...
class MedioDigital(models.Model):
	...
	def __unicode__(self):
		return self.medio
	sitioweb = models.URLField("Sitio WEB", max_length=255, null=True, blank=True, help_text="http://...")
	genero = select2.fields.ForeignKey(GeneroMedioDigital, related_name="mediodigital_genero", null=True, blank=True)
	COBERTURA = (
		('Nacional', 'Nacional'),
		('Regional', 'Regional'),
		('Departamental', 'Departamental'),
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Departamento", related_name="mediodigital_region", blank=True, help_text="Actualice con F5")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Municipio", related_name="mediodigital_ciudad", blank=True, help_text="Actualice con F5")
	direccion = models.CharField("Dirección", max_length=255, blank=True, help_text="Calle-Nº-Departamento-Municipio")
